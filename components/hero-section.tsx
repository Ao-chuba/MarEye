...
import { ArrowRight, Radar, Target, Eye, Fish, Anchor } from "lucide-react"
...
export function HeroSection() {
  ...
  // Marine security images for slideshow - 4 security focused images
  const marineSecurityImages = [
    "/images/security1.jpg", // Submarine detection
    "/images/security2.jpg", // Mine detection
    "/images/security3.jpg", // Underwater drone surveillance
    "/images/security4.jpg", // Sonar and threat assessment
  ]
